                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="e.g Your Name" value="" />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="Enter Your Phone No" value="" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Password <span class="text-danger">*</span></label>
                                    <input type="password" name="password" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="Enter Your Password" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Confirm Password <span class="text-danger">*</span></label>
                                    <input type="password" name="password_confirmation" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="Confirm Your Password" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Roll <span class="text-danger">*</span></label>
                                    <input type="text" name="roll" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="Enter Your Roll No" />
                                </div>
                                
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Registrarion <span class="text-danger">*</span></label>
                                    <input type="text" name="registration" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="Enter Your Registration" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Session <span class="text-danger">*</span></label>
                                    <input type="text" name="session" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="Enter Your Session" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Address <span class="text-danger">*</span></label>
                                    <input type="text" name="address" class="form-control form-control-lg bg-white bg-opacity-5" placeholder="Enter Your Address" />
                                </div>
                                <div class="mb-3">
