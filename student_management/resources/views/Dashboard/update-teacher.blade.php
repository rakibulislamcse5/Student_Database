...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('Dashboard/TeacherUpdateAction/') }}/{{ $update->id; }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" for="name">Password : Skip this field for user define password</label>
                            <input type="text" name="password" class="form-control" id="name" placeholder="User password">
                        </div>
                        <div class="form-group mb-3">
                ...
                <div class="mb-3 row">
                    <div class="col-sm-10 offset-sm-1">
                        <input type="submit" class="btn btn-outline-theme btn-lg d-block w-100 fw-500 mb-3" value="Update Teacher">
                    </div>
                </div>
            </form>
            <hr/>
