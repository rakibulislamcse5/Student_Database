...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ url('/Dashboard/TeacherAddAction') }}" method="post">
                @csrf
                @if(session('danger'))
                    <div class="alert alert-danger" role="alert">
                        {{ session('danger') }}.
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" for="name">Teacher Id No</label>
                            <input name="roll" class="form-control" id="name" placeholder="Enter User Roll">
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label" for="name">Teacher Registration</label>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" for="name">Teacher Email</label>
                            <input type="email" name="email" class="form-control" id="name" placeholder="Enter User Email">
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label">Teacher Trade <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label" for="name">Teacher Password</label>
                ...
                <div class="mb-3 row">
                    <div class="col-sm-10 offset-sm-1">
                        <input type="submit" class="btn btn-outline-theme btn-lg d-block w-100 fw-500 mb-3" value="Add Teacher">
                    </div>
                </div>
            </form>
        </div>
